 ...
 */
@Entity
@Table(name = "AIMS_CHOICE_RESULT_PUB")
public class AuChoiceResultPublish {

    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "SEQ_GEN", sequenceName = "AIMS_CHOICE_RESULT_PUB_SEQ", allocationSize = 1)
    ...
    public AuChoiceResultPublish() {
    }

    public AuChoiceResultPublish(Long choiceResultID, Long userID, Timestamp genDate, Long actStatus, String actDesc, Long reqPublishSource) {
