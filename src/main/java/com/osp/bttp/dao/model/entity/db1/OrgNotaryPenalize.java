...
@Entity
@Table(name = "ORG_NOTARY_PENALIZE")
public class OrgNotaryPenalize implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
    @Basic(optional = false)
    @Column(name = "ID")
    @SequenceGenerator(name="ORG_NOTARY_PENALIZE_SEQ", sequenceName="ORG_NOTARY_PENALIZE_SEQ",allocationSize=1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ORG_NOTARY_PENALIZE_SEQ")
    private Long id;
    ...
    public OrgNotaryPenalize() {
    }

    public OrgNotaryPenalize(Long id) {
        this.id = id;
    }
