...
@Data
public class NotaryInfoDetailView {
    @Schema(description = "Thông tin bổ nhiệm CCV")
    private List<NotaryAppointResponse> notaryAppointResponses;
    @Schema(description = "Đăng ký HNCC và cấp thẻ CCV")
    private NotaryRegAndAuctionCardResponse notaryRegAndAuctionCardResponse;
    @Schema(description = "Thông tin đăng ký tập sự HNCC")
    private NotaryProbationaryResponse notaryProbationaryResponse;
    @Schema(description = "Thông tin tạm đình chỉ HNCC")
    private NotarySuspendWorkResponse notarySuspendWorkResponse;
    @Schema(description = "Thông tin xử phạt HNCC")
    private List<NotaryPenalizeResponse> notaryPenalizeResponse;
    /*NotaryInfo*/
    ...
    public String getStatusNotaryInfoStr() {
        statusNotaryInfoStr = ConstantsTccc.NOTARY_STATUS.getStr(status,statusNotaryInfoStr);
